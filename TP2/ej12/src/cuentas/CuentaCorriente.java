...
public class CuentaCorriente extends CuentaBancaria {
    ...
    public CuentaCorriente( int numeroCuenta, double saldo, double saldoMinimo){
    ...
    public String toString() {
        return "\nCuenta Corriente Nro: " + this.getNumeroCuenta() + ", Saldo: " + this.getSaldo() + ", Saldo Minimo: "+ this.saldoMinimo;
    }
